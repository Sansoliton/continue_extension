...
class MeasurementMethodologyContextProvider extends BaseContextProvider {
  static description: ContextProviderDescription = {
    title: "measurementMethodology",
    displayTitle: "Measurement",
    description: "List of test methodologies from measurements",
    type: "submenu",
  };
  ...
  async getContextItems(
    ...
    extras: ContextProviderExtras,
      ...
      try {
        ...
        const filePath = path.join(currentDirectory, "src","measurement_methodology", query);
  ...
  async loadSubmenuItems(
    ...
    try {
      ...
      const datasheetDirPath = path.join(currentDirectory, "src","measurement_methodology");
...
export default MeasurementMethodologyContextProvider;
